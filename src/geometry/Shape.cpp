...
void Shape::init_type(std::string arg_type, EntityList<Point>* arg_nodes){
	...
	area = 0.5*((arg_nodes -> get_entity(0, true).get_x())*(arg_nodes -> get_entity(1,true).get_y() - arg_nodes -> get_entity(2,true).get_y()) - (arg_nodes -> get_entity(0,true).get_y())*(arg_nodes -> get_entity(1,true).get_x() - arg_nodes -> get_entity(2,true).get_x()) + ((arg_nodes -> get_entity(1,true).get_x())*(arg_nodes -> get_entity(2,true).get_y())) - ((arg_nodes -> get_entity(2,true).get_x())*(arg_nodes -> get_entity(1,true).get_y())));
}
